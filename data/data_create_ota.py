...
class data_create_ota:
    def user_create(self):
        #构造系统账户
        'SELECT * FROM sys_user_role WHERE user_id=jiang091201'
        sql_sys_user_role= "insert into sys_user_role(`id`,`user_id`,`role_id`) values(%s, %s, %s)"
        sql_sys_user_depart="insert into sys_user_depart(`ID`,`user_id`,`dep_id`) values(%s, %s, %s)"
        db127.itri_ota_cursor.execute('SELECT * FROM sys_user WHERE username="13692659789"')
        result = db127.itri_ota_cursor.fetchall()
        sql = "insert into sys_user(`id`,`username`,`realname`,`password`,`salt`,`org_code`,`status`,`del_flag`,`work_no`,`role_code`,`depart_ids`,`create_by`,`create_time`," \
              "`update_by`,`update_time`) values(%s, %s, %s, %s,%s, %s, %s, %s,%s, %s, %s, %s,%s, %s, %s)"
        if len(result) == 0:
            data1 = ('a25462042f8a422f863ca93457fc3b94', '13692659789', '江华坤',
                     '2685f513d9656e08d10cf6c1102e5de0', 'qzE2WhMK', None,
                      1, 0, None,
            ...
            #print("系统账户 exit")
        #插入角色
        db127.itri_ota_cursor.execute('SELECT * FROM sys_user_role WHERE user_id="a25462042f8a422f863ca93457fc3b94"')
        result_role_1 = db127.itri_ota_cursor.fetchall()
        if len(result_role_1) == 0:
            data1 = ('aa1e00def14d4e3aab7', 'a25462042f8a422f863ca93457fc3b94', 'f6817f48af4fb3af11b9e8bf182f618b')
            db127.itri_ota_cursor.execute(sql_sys_user_role, data1)
            db127.itri_ota.commit()
            #print("系统账户 插入数据成功")
        else:
            pass
        ...
        #构造部门用户
        #构造部门用户-关联1个部门
        db127.itri_ota_cursor.execute('SELECT * FROM sys_user WHERE username="13692659860"')
        result1 =db127.itri_ota_cursor.fetchall()
        if len(result1)==0:
            data1=('741e7764fa4f4afc9fa6c61e1f9cac5c', '13692659860', 'jianghuakun', '2685f513d9656e08d10cf6c1102e5de0', 'zhg7Yl7o', None, 1, 0, None, 'itri_depart', '984bbb24e4614c6a9770d892c7d2fd54', 'jianghuakun', '2020-09-12 09:38:28', None,  None)
            db127.itri_ota_cursor.execute(sql,data1)
            db127.itri_ota.commit()
            ...
            #print("关联一个部门用户存在")
        #插入角色
        db127.itri_ota_cursor.execute('SELECT * FROM sys_user_role WHERE user_id="741e7764fa4f4afc9fa6c61e1f9cac5c"')
        result_role_2 = db127.itri_ota_cursor.fetchall()
        if len(result_role_2) == 0:
            data1 = ('a5c117015abb4ff5868', '741e7764fa4f4afc9fa6c61e1f9cac5c', '2633e801f7f54d81925c7d4f11946e08')
            db127.itri_ota_cursor.execute(sql_sys_user_role, data1)
            db127.itri_ota.commit()
            # print("系统账户 插入数据成功")
        else:
        ...
        # 关联部门
        db127.itri_ota_cursor.execute('SELECT * FROM sys_user_depart WHERE user_id="741e7764fa4f4afc9fa6c61e1f9cac5c"')
        result_dep_1 = db127.itri_ota_cursor.fetchall()
        if len(result_dep_1) == 0:
            data1 = ('dc3382dab6ee42458cc', '741e7764fa4f4afc9fa6c61e1f9cac5c', '984bbb24e4614c6a9770d892c7d2fd54')
            db127.itri_ota_cursor.execute(sql_sys_user_depart, data1)
            db127.itri_ota.commit()
            # print("系统账户 插入数据成功")
        else:
            pass
        ...
        #关联2个部门
        db127.itri_ota_cursor.execute('SELECT * FROM sys_user WHERE username="13692659861"')
        result11 = db127.itri_ota_cursor.fetchall()
        if len(result11) == 0:
            data1 = ('6d13a2eb50be41abbed13926f88b391a', '13692659861', '09113',
                     '2685f513d9656e08d10cf6c1102e5de0', 'avdHVAOZ', None, 1, 0, None,
        ...
        #插入角色
        db127.itri_ota_cursor.execute('SELECT * FROM sys_user_role WHERE user_id="6d13a2eb50be41abbed13926f88b391a"')
        result_role_3 = db127.itri_ota_cursor.fetchall()
        if len(result_role_3) == 0:
            data1 = ('d576e302687a4c64b3c', '6d13a2eb50be41abbed13926f88b391a', '2633e801f7f54d81925c7d4f11946e08')
            db127.itri_ota_cursor.execute(sql_sys_user_role, data1)
            db127.itri_ota.commit()
            # print("系统账户 插入数据成功")
        else:
        ...
        # 关联2个部门
        db127.itri_ota_cursor.execute('SELECT * FROM sys_user_depart WHERE user_id="6d13a2eb50be41abbed13926f88b391a"')
        result_dep_2 = db127.itri_ota_cursor.fetchall()
        if len(result_dep_2) == 0:
            data1 = ('f529f14dd3cc473e987', '6d13a2eb50be41abbed13926f88b391a', '984bbb24e4614c6a9770d892c7d2fd54')
            data2 = ('9616fa16826b4ddabb7', '6d13a2eb50be41abbed13926f88b391a',
                     '5a98dcba815c49aea35dc199dde878c2')
            db127.itri_ota_cursor.execute(sql_sys_user_depart, data1)
            db127.itri_ota_cursor.execute(sql_sys_user_depart, data2)
            db127.itri_ota.commit()
            # print("系统账户 插入数据成功")
        else:
            pass
        #部门用户编辑使用
        db127.itri_ota_cursor.execute('SELECT * FROM sys_user WHERE username="13692659862"')
        result2 = db127.itri_ota_cursor.fetchall()
        if len(result2) == 0:
            data1 = ('be575b34bce14d32a044d7f6ff97f1bc', '13692659862', '江华坤',
                     '2685f513d9656e08d10cf6c1102e5de0', 'WxAlntoI', None, 1, 0, None,
        ...
        #插入角色
        db127.itri_ota_cursor.execute('SELECT * FROM sys_user_role WHERE user_id="be575b34bce14d32a044d7f6ff97f1bc"')
        result_role_4 = db127.itri_ota_cursor.fetchall()
        if len(result_role_4) == 0:
            data1 = ('a41dc172175349ba9bb', 'be575b34bce14d32a044d7f6ff97f1bc', '2633e801f7f54d81925c7d4f11946e08')
            db127.itri_ota_cursor.execute(sql_sys_user_role, data1)
            db127.itri_ota.commit()
            # print("系统账户 插入数据成功")
        else:
        ...
        # 关联部门
        db127.itri_ota_cursor.execute('SELECT * FROM sys_user_depart WHERE user_id="be575b34bce14d32a044d7f6ff97f1bc"')
        result_dep_3 = db127.itri_ota_cursor.fetchall()
        if len(result_dep_3) == 0:
            data1 = ('0702b5e428f3434ba5e', 'be575b34bce14d32a044d7f6ff97f1bc',
                     '984bbb24e4614c6a9770d892c7d2fd54')
            db127.itri_ota_cursor.execute(sql_sys_user_depart, data1)
            db127.itri_ota.commit()
            # print("系统账户 插入数据成功")
        else:
        ...
        db127.itri_ota_cursor.execute('SELECT * FROM sys_user WHERE username="13692659863"')
        result21 = db127.itri_ota_cursor.fetchall()
        if len(result21) == 0:
            data1 = ('66ceb473b35c4819a5b997ecd1d99772', '13692659863', '江华坤',
                     '2685f513d9656e08d10cf6c1102e5de0', 'dSQVFEYe', None, 1, 0, None,
        ...
        db127.itri_ota_cursor.execute('SELECT * FROM sys_user_role WHERE user_id="66ceb473b35c4819a5b997ecd1d99772"')
        result_role_5 = db127.itri_ota_cursor.fetchall()
        if len(result_role_5) == 0:
            data1 = ('120c647e30df4d608a8', '66ceb473b35c4819a5b997ecd1d99772', '2633e801f7f54d81925c7d4f11946e08')
            db127.itri_ota_cursor.execute(sql_sys_user_role, data1)
            db127.itri_ota.commit()
            # print("系统账户 插入数据成功")
        else:
        ...
        # 关联部门
        db127.itri_ota_cursor.execute('SELECT * FROM sys_user_depart WHERE user_id="66ceb473b35c4819a5b997ecd1d99772"')
        result_dep_4 = db127.itri_ota_cursor.fetchall()
        if len(result_dep_4) == 0:
            data1 = ('e107a6a814aa478fa68', '66ceb473b35c4819a5b997ecd1d99772',
                     '7d4c693baebe4278ad82fa072ee19924')
            db127.itri_ota_cursor.execute(sql_sys_user_depart, data1)
            db127.itri_ota.commit()
            # print("系统账户 插入数据成功")
        else:
        ...
        #系统用户编辑删除使用
        db127.itri_ota_cursor.execute('SELECT * FROM sys_user WHERE username="13692659864"')
        ...
        if len(result3) == 0:
            data1 = ('b366f059186347c69791e87d4de94e2d', '13692659864','江华坤','2685f513d9656e08d10cf6c1102e5de0', 'O7vDjSYj',  None,1, 0,None,'itri_all',None,'jianghuakun', '2020-09-12 10:02:16', None,None)
            db127.itri_ota_cursor.execute(sql, data1)
            db127.itri_ota.commit()
            #print("系统账户 插入数据成功")
        else:
        ...
        #批量删除使用
        db127.itri_ota_cursor.execute('SELECT * FROM sys_user WHERE username="13692659865"')
        ...
        if len(result31) == 0:
            data11 = ('3471e47a0f484aab8a93afea2ac5dc70', '13692659865', '江华坤',
                     '2685f513d9656e08d10cf6c1102e5de0', 'Uv19wBEU',None, 1, 0, None, 'itri_all',None,
        ...
        #
        db127.itri_ota_cursor.execute('SELECT * FROM sys_user WHERE username="13692659866"')
        result32 = db127.itri_ota_cursor.fetchall()
        #sql = "insert into sys_user(`id`,`username`,`realname`,`password`,`salt`,`email`,`phone`,`org_code`,`status`,`del_flag`,`work_no`,`role_code`,`create_by`,`create_time`,`update_by`,`update_time`) values( %s, %s,%s, %s, %s, %s,%s, %s, %s, %s,%s, %s, %s, %s,%s, %s)"
        if len(result32) == 0:
            data11 = ('6476a72861b840daaf064dd6377683aa', '13692659866', '江华坤',
                      '2685f513d9656e08d10cf6c1102e5de0', 'mdjdESUm', None, 1, 0, None, 'itri_depart','984bbb24e4614c6a9770d892c7d2fd54',
            ...
            pass
        #
        db127.itri_ota_cursor.execute('SELECT * FROM sys_user WHERE username="13692659867"')
        result33 = db127.itri_ota_cursor.fetchall()
        #sql = "insert into sys_user(`id`,`username`,`realname`,`password`,`salt`,`email`,`phone`,`org_code`,`status`,`del_flag`,`work_no`,`role_code`,`create_by`,`create_time`,`update_by`,`update_time`) values( %s, %s,%s, %s, %s, %s,%s, %s, %s, %s,%s, %s, %s, %s,%s, %s)"
        if len(result33) == 0:
            data11 = ('448e4731333b45ce9062ecb2f68387d7', '13692659867', '江华坤',
                      '2685f513d9656e08d10cf6c1102e5de0', 'W4Bax0RO', None, 1, 0, None, 'itri_depart', '984bbb24e4614c6a9770d892c7d2fd54', 'jianghuakun', '2020-09-07 11:13:13', None,
                      None)
            db127.itri_ota_cursor.execute(sql, data11)
            db127.itri_ota.commit()
            # print("系统账户 插入数据成功")
    ...
    def depart_create(self):
        ...
        sql = "insert into sys_depart(`id`,parent_id,`depart_name`,`depart_name_en`,`depart_no`,`depart_order`,`org_type`,`org_code`,`mobile`,`fax`,`address`,`upgrade_type`,`status`,`del_flag`,`apikey`,`apisecret`,`description`,`create_by`,`create_time`,`update_by`,`update_time`) values(%s, %s, %s, %s, %s, %s,%s, %s, %s, %s,%s, %s, %s,%s,%s, %s, %s, %s,%s,%s, %s)"
        if len(result51) == 0:
            data5 = (
                'efce7f79ee1447a2add33430c3b56240', None, '江测试0907-1',
                '09071', None,0, 1, "A31",None,None,None,None, 1, 0,None,None,None,
        ...
        if len(result52) == 0:
            data5 = (
                ...
                '090721', None, 0, 2, "A31A01", None, None, None, None, 1, 0, None,None,None,
        ...
        if len(result56) == 0:
            data5 = (
                ...
                '090822', None, 0, 2, "A31A02", None, None, None, None, 1, 0, None,None,None,
        ...
        if len(result57) == 0:
            data5 = (
                ...
                '09121734', None, 0, 2, "A31A03", None, None, None, None, 1, 0, None,None,None,
        ...
        if len(result53) == 0:
            data5 = (
                ...
                'jiang090731', None, 0, 3, "A31A01A01", None, None, None, 1, 1, 0, "itriq4xvj5tjpyr0","828364aeyr6fgenf6jz97h2094ijui9efpxgno70",None,
        ...
        if len(result54) == 0:
            data5 = (
                ...
                '090801', None, 0, 3, "A31A01A02", None, None, None, 0, 1, 0,"itriq4xvj5tjpyr1","828364aeyr6fgenf6jz97h2094ijui9efpxgno71", None,
        ...
        if len(result55) == 0:
            data5 = (
                ...
                '0909', None, 0, 3, "A31A01A03", None, None, None, 0, 1, 0, "itriq4xvj5tjpyr2","828364aeyr6fgenf6jz97h2094ijui9efpxgno72",None,
        ...
        if len(result57) == 0:
            data5 = (
                ...
                '090833', None, 0, 3, "A31A02A01", None, None, None, 0, 1, 0, "itriq4xvj5tjpyr3","828364aeyr6fgenf6jz97h2094ijui9efpxgno73",None,
        ...
        if len(result58) == 0:
            data5 = (
                ...
                '090902', None, 0, 3, "A31A02A02", None, None, None, 0, 1, 0,"itriq4xvj5tjpyr4","828364aeyr6fgenf6jz97h2094ijui9efpxgno74",None,
        ...
        print(result2)
        if len(result2)==0:
            data2 = ('b724b422e68945ff8f3f1dc7997d06f4','500f1e534cfc4a5c8336de71123f0c83','jiang-autotest-2级部门-1', 'jiangautotest21',None, 0, 2, "A90A01", None, None, None, None, 1, 0,None,None, None,
        ...
        sql5 = "insert into sys_depart(`id`,parent_id,`depart_name`,`depart_name_en`,`depart_order`,`org_type`,`org_code`,`upgrade_type`,`status`,`del_flag`,`apikey`,`apisecret`,`create_by`,`create_time`,`update_by`,`update_time`) values(%s,%s,%s, %s, %s, %s,%s, %s, %s, %s,%s, %s, %s,%s,%s, %s)"
        if len(result5) == 0:
            data5 = (
                '1ec219ce8ec94fb4b2055b15ae054e6e', '4ba6ade2f0c54f668b64392120b5c80d', '3级部门1',
                'jiangautotest31', 0, 3, "A90A02A01",1, 1, 0,"itriq4xvj5tjpyr5","828364aeyr6fgenf6jz97h2094ijui9efpxgno75",
        ...
        result51 = db127.itri_ota_cursor.fetchall()
        sql51 = "insert into sys_depart(`id`,parent_id,`depart_name`,`depart_name_en`,`depart_order`,`org_type`,`org_code`,`upgrade_type`,`status`,`del_flag`,`apikey`,`apisecret`,`create_by`,`create_time`,`update_by`,`update_time`) values(%s,%s,%s, %s, %s, %s,%s, %s, %s, %s,%s, %s, %s,%s,%s, %s)"
        if len(result51) == 0:
            data51 = (
                '41159ee1c7c2405680963e41315ed6f5', '4ba6ade2f0c54f668b64392120b5c80d', 'jiang-autotest-3级部门-2',
                'jiangautotest32', 0, 3, "A90A02A02",0, 1, 0,"itriq4xvj5tjpyr6","828364aeyr6fgenf6jz97h2094ijui9efpxgno76",
        ...
        result52 = db127.itri_ota_cursor.fetchall()
        sql52 = "insert into sys_depart(`id`,parent_id,`depart_name`,`depart_name_en`,`depart_order`,`org_type`,`org_code`,`upgrade_type`,`status`,`del_flag`,`apikey`,`apisecret`,`create_by`,`create_time`,`update_by`,`update_time`) values(%s,%s,%s, %s, %s, %s,%s, %s, %s, %s,%s, %s, %s,%s,%s, %s)"
        if len(result52) == 0:
            data52 = (
                'e2429e3841604e10880dc10b02e088c2','4ec536de450c44ab848ce3b1c1725442','jiang-autotest-3级部门-3','jiangautotest33',0,3,"A90A03A01",1,1,0,"itriq4xvj5tjpyr7","828364aeyr6fgenf6jz97h2094ijui9efpxgno77",'itriota','2020-08-10 09:14:04','itriota','2020-08-10 09:14:048')
        ...
        sql8 = "insert into sys_depart(`id`,`parent_id`,`depart_name`,`depart_name_en`,`depart_order`,`org_type`,`org_code`,`upgrade_type`,`status`,`del_flag`,`apikey`,`apisecret`,`create_by`,`create_time`,`update_by`,`update_time`) values(%s,%s,%s, %s, %s, %s,  %s,%s, %s, %s, %s,%s, %s,%s, %s, %s)"
        if len(result8) == 0:
            data8 = (
                '41159ee1c7c2405680963e41315ed6f5', '4ba6ade2f0c54f668b64392120b5c80d', 'jiang-autotest-3级部门-2',
                'jiangautotest32', 0, 3, "A90A02A02", 1,1, 0,"itriq4xvj5tjpyr8","828364aeyr6fgenf6jz97h2094ijui9efpxgno78",
                'itriota',
    ...
    def oss_file_create(self):
        ...
        db127.itri_ota_cursor.execute('SELECT * FROM t_oss_file WHERE id="26e591bfec59444b9da940ca19f9c657"')
        result = db127.itri_ota_cursor.fetchall()

        # 新增文件记录1-1
        if len(result) == 0:
            data = (
                '26e591bfec59444b9da940ca19f9c657', '10611880139241048990bd5d7f4be58c', 0,
                'com.bmwxzpj1.apk', "baimao2.81", "2.81", 12339036, "680839d893dd923a9f8ed9aecb34583f",
                "https://fenda-itri-t1-830.oss-cn-shenzhen.aliyuncs.com/jiangtest3/jiangnomobile15/jiangtestsetoss/app/2.8/1594799897764-69900ce7ad5343bd9f64c13f0e84adsc.apk",
                'jiangtestdepend_1-1',
                '2020-08-07 10:59:20')
            db127.itri_ota_cursor.execute(sql, data)
            db127.itri_ota.commit()
    ...
    def version_create(self):
        sql = "insert into t_version(`id`, `task_name`,`version`,`depart_id`,`file_id`,`changle_log`,`overseas_changle_log`,`source`,`limit_number`,`version_whitelist`,`user_group_ids`,`network_type`,`force_flag`,`battery_threshold`,`status`,`del_flag`,`release_chain`,`description`,`create_by`,`create_time`,`update_by`,`update_time`) values( %s,%s,%s,%s, %s,%s, %s, %s, %s,%s, %s,%s, %s, %s, %s, %s, %s,%s, %s,%s, %s, %s)"
        ...
        if len(result)==0:
            data = (
                '07e4f3cb685749bcac2951beef6bc940', 'keep1.0',"2.8","10611880139241048990bd5d7f4be58c","02f2f6b9c4f4447b8d6cf3e6eccf7708","2.8","2.8", 0,0,
                '0.0.8',None, 0,0,"60%", 1,0,1,"2.8", "itriota", "2020-08-10 08:41:10", "itriota", "2020-08-10 08:41:10")
            db127.itri_ota_cursor.execute(sql, data)
            db127.itri_ota.commit()
            #print("系统账户 插入数据成功")
        else:
        ...
        if len(result) == 0:
            data = (
                ...
                "3b94aedd2dc44a2ebb13bdfc83d20338", "t2.4","t2.4", 0, 0,
                '1.0.0', None, 1, 0,"60%", 1, 0,1, "3.1", "itriota", "2020-08-11 10:28:03", "itriota", "2020-08-11 10:28:03")
            db127.itri_ota_cursor.execute(sql, data)
            db127.itri_ota.commit()
            # print("系统账户 插入数据成功")
        else:
        ...
        if len(result) == 0:
            data = (
                ...
                "3b94aedd2dc44a2ebb13bdfc83d20339", "t2.4","t2.4", 0, 0,
                '1.0.0', None, 1, 0,"60%", 1, 0,1, "3.1", "itriota", "2020-08-11 10:28:03", "itriota", "2020-08-11 10:28:03")
            db127.itri_ota_cursor.execute(sql, data)
            db127.itri_ota.commit()
            # print("系统账户 插入数据成功")
        ...
        if len(result) == 0:
            data = (
                ...
                "3b94aedd2dc44a2ebb13bdfc83d20340", "t21.4","t21.4", 0, 0,
                '0.0.8', None, 1, 0, "60%", 1, 0,1, "3.1", "itriota", "2020-08-11 10:28:03", "itriota",
                "2020-08-11 10:28:03")
            db127.itri_ota_cursor.execute(sql, data)
            db127.itri_ota.commit()
            # print("系统账户 插入数据成功")
    ...
    # 新增出厂版本
    def version_factory_create(self):
        sql = "insert into t_version_factory(`id`,`version`,`depart_id`,`description`,`create_by`,`create_time`) values( %s,%s, %s,%s, %s, %s)"
        # 出厂版本1
        db127.itri_ota_cursor.execute(
            'SELECT * FROM t_version_factory WHERE id="e2429e3841604e10880dc10b02e088c21"')
        result = db127.itri_ota_cursor.fetchall()
        #print(result)

        if len(result) == 0:
            data = (
                'e2429e3841604e10880dc10b02e088c21', '1.0.0', "10611880139241048990bd5d7f4be58c", None,
                "jianghuakun", "2020-08-25 11:15:51")
            db127.itri_ota_cursor.execute(sql, data)
            db127.itri_ota.commit()
            # print("系统账户 插入数据成功")
        else:
        ...
        # 出厂版本2
        db127.itri_ota_cursor.execute(
            'SELECT * FROM t_version_factory WHERE id="e2429e3841604e10880dc10b02e088c22"')
        result = db127.itri_ota_cursor.fetchall()
        #print(result)

        if len(result) == 0:
            data = (
                'e2429e3841604e10880dc10b02e088c22', '1.0.1', "10611880139241048990bd5d7f4be58c", None,
                "jianghuakun", "2020-08-25 11:15:51")
            db127.itri_ota_cursor.execute(sql, data)
            db127.itri_ota.commit()
            # print("系统账户 插入数据成功")
        ...
        # 出厂版本3
        db127.itri_ota_cursor.execute(
            'SELECT * FROM t_version_factory WHERE id="e2429e3841604e10880dc10b02e088c23"')
        result = db127.itri_ota_cursor.fetchall()
        #print(result)

        if len(result) == 0:
            data = (
                'e2429e3841604e10880dc10b02e088c23', '1.0.2', "10611880139241048990bd5d7f4be58c", None,
                "jianghuakun", "2020-08-25 11:15:51")
            db127.itri_ota_cursor.execute(sql, data)
            db127.itri_ota.commit()
            # print("系统账户 插入数据成功")
        ...
        # 出厂版本4
        db127.itri_ota_cursor.execute(
            'SELECT * FROM t_version_factory WHERE id="e2429e3841604e10880dc10b02e088c24"')
        result = db127.itri_ota_cursor.fetchall()
        #print(result)

        if len(result) == 0:
            data = (
                'e2429e3841604e10880dc10b02e088c24', '1.0.3', "10611880139241048990bd5d7f4be58c", None,
                "jianghuakun", "2020-08-25 11:15:51")
            db127.itri_ota_cursor.execute(sql, data)
            db127.itri_ota.commit()
            # print("系统账户 插入数据成功")
        ...
        # 出厂版本5
        db127.itri_ota_cursor.execute(
            'SELECT * FROM t_version_factory WHERE id="e2429e3841604e10880dc10b02e088c25"')
        result = db127.itri_ota_cursor.fetchall()
        #print(result)

        if len(result) == 0:
            data = (
                'e2429e3841604e10880dc10b02e088c25', '1.0.4', "10611880139241048990bd5d7f4be58c", None,
                "jianghuakun", "2020-08-25 11:15:51")
            db127.itri_ota_cursor.execute(sql, data)
            db127.itri_ota.commit()
            # print("系统账户 插入数据成功")
